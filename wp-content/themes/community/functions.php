...
function bones_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'home-sidebar-top',
		'name' => __( 'Home Top', 'bonestheme' ),
		'description' => __( 'The top homepage widget area.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widgettitle">',
		'after_title' => '</h3>',
	...
	register_sidebar(array(
		'id' => 'home-sidebar-mid-left',
		'name' => __( 'Home Middle Left', 'bonestheme' ),
		'description' => __( 'The middle left homepage widget area.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widgettitle">',
		'after_title' => '</h3>',
	...
	register_sidebar(array(
		'id' => 'home-sidebar-mid-right',
		'name' => __( 'Home Middle Right', 'bonestheme' ),
		'description' => __( 'The middle right homepage widget area.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widgettitle">',
		'after_title' => '</h3>',
	...
	register_sidebar(array(
		...
		'name' => __( 'Home Bottom', 'bonestheme' ),
		'description' => __( 'The bottom homepage widget area.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widgettitle">',
		'after_title' => '</h3>',
