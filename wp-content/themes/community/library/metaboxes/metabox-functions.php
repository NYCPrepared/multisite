...
add_filter( 'cmb_meta_boxes', 'cmb_community_metaboxes' );
/**
...
function cmb_community_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes['sites_metabox'] = array(
		...
		'fields'     => array(
			array(
				...
				'desc'    => __( 'Select the sites that are part of this network', 'community' ),
	...
	$meta_boxes['volunteer_location_metabox'] = array(
		...
		'title'         => __( 'Location Information', 'community' ),
		...
		'fields'        => array(
			array(
				...
				'desc' => __( 'Enter location of volunteer opportunity', 'community' ),
				'id'   => $prefix . 'test_text',
				'type' => 'text',
