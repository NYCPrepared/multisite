...
<br />
<input type='radio' name='glo_networkexclude' value='1'<?php if( $excluded == 1 ) echo " checked"?>> <?php _e('Exclude this blog from networks aggregation') ?>&nbsp;&nbsp;	
</td>
</tr>
</table>
	<?php
...
// set the network
	...
	if ($_POST['glo_networkexclude'] == 1) {
		// exclude this blog
		glo_bn_toggle_blog_exclusion($id, 'e');
	}
	else {
		// include this blog
